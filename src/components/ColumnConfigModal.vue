...
<template>
  <Transition name="slide">
    <aside
      v-if="open && column"
      class="absolute inset-y-0 right-0 w-96 bg-white shadow-2xl z-40 flex flex-col overflow-hidden"
    ...
    >
      ...
      <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
        <div>
          <h2 class="text-lg font-semibold text-gray-900">Configure Column</h2>
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              class="w-full px-3 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <!-- Type -->
          <div>
            <label for="column-type" class="block text-sm font-medium text-gray-700 mb-2">
              Type
            </label>
            <select
              id="column-type"
          ...
          <div v-if="columnRelations.length > 0">
            <label class="block text-sm font-medium text-gray-700 mb-3">Relations</label>
            <div class="space-y-2">
              <button
                v-for="relation in columnRelations"
                :key="relation.id"
                @click="handleRelationClick(relation.id)"
                class="w-full text-left p-3 border rounded-lg hover:bg-gray-50 transition-colors group"
          ...
          <!-- Properties -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-3">Properties</label>
            <div class="space-y-3">
              <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div class="flex-1">
                  <span class="text-sm font-medium text-gray-900">Nullable</span>
                  <p class="text-xs text-gray-500 mt-0.5">Allow NULL values</p>
                </div>
              </label>
              ...
              <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div class="flex-1">
                  <span class="text-sm font-medium text-gray-900">Primary Key</span>
                  <p class="text-xs text-gray-500 mt-0.5">Unique identifier for the table</p>
                </div>
              </label>
              ...
              <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div class="flex-1">
                  <span class="text-sm font-medium text-gray-900">Unique</span>
                  <p class="text-xs text-gray-500 mt-0.5">All values must be unique</p>
                </div>
              </label>
              ...
              <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                ...
                />
                <div class="flex-1">
                  <span class="text-sm font-medium text-gray-900">Auto Increment</span>
                  <p class="text-xs text-gray-500 mt-0.5">Automatically increment value</p>
                </div>
              </label>
            </div>
          </div>
