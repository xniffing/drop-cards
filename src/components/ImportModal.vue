    ...
    >
      ...
      <div class="mb-4">
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
          Paste your Drizzle schema code below. The schema should include table definitions using <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded">sqliteTable()</code> and optional relations using <code class="bg-gray-100 dark:bg-gray-700 px-1 rounded">relations()</code>.
        </p>
      </div>
